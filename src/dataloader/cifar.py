...
class CIFAR10(VisionDataset):
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None, download=False, index=None, base_sess=None, min_scale=None):
        ...
        train_transform, test_transform = self.get_cifar_transforms()
    ...
    def download(self):
        if self._check_integrity():
            print('Dataset: Files already downloaded and verified')
            return
    ...
    def get_cifar_transforms(self):
        ...
        test_transform = transforms.Compose([
            transforms.Resize(_img_resize_size, interpolation=Image.BICUBIC),
